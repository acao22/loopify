...
function GenerateSong() {
    const CLIENTID = "Eq8KSecb2Yz4Lq--EUjuGWH_8OifHCRwdwHr1ztKdLx5Qk_zCZG--AXPSQzMXhL-";
    const CLIENTSECRET = "-3Ynmxt9BZab3Qs5sbr_GdzGxXoGqSqbSISFuEQwquYeVm-5-A3nFIcgUOvDSY731GT-hhJtvTK5jYDccT7juQ";
    ...
    return (
        <div className="flex flex-col md:flex-row items-start justify-center bg-gradient-to-b from-[#4D9B0E] to-[#1A3505] min-h-screen p-6">
            <div className="bg-white rounded-lg shadow-lg p-6 max-w-md w-full">
                ...
                <h2 className="text-xl font-semibold text-center mb-6">Random Song Generator</h2>
